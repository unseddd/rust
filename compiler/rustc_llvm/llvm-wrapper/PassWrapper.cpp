...
extern "C" LLVMPassRef LLVMRustCreateSymbolizePass() {
  return wrap(createSymbolizeLegacyPass());
}
...
LLVMRustOptimizeWithNewPassManager(
  ...
  if (SanitizerOptions) {
    ...
    if (SanitizerOptions->SanitizeSymbolize) {
//#if LLVM_VERSION_GE(11, 0)
//      OptimizerLastEPCallbacks.push_back(
//        [](ModulePassManager &MPM, PassBuilder::OptimizationLevel Level) {
//          MPM.addPass(std::move(SymbolizePass()));
//        }
//      );
//#else
//#if LLVM_VERSION_GE(10, 0)
